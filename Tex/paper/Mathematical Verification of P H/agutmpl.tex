...
\titlerunninghead{Mathematical Verification of Propotionality Hypothesis}

%------------------------------------------------

% Corresponding author mailing address and e-mail address:
\authoraddr{Corresponding author: Baoxiang Pan, Center for Hydrometeorology and Remote Sensing, University of California, Irvine, Irvine, California, USA. (baoxianp@uci.edu)}
...
\authors{Baoxiang Pan,\altaffilmark{1,2} and 
Zhentao Cong,\altaffilmark{2}}

\altaffiltext{1}{Center for Hydrometeorology and Remote Sensing, University of California, Irvine, Irvine, California, USA.}

\altaffiltext{2}{Institute of Hydrology and Water Resources, Tsinghua University, Beijing, China.}
...
\subsection{SCS ABCD Budyko}

\subsection{Proportionality Hypothesis}

\subsection{Stochastic Soil Moisture Model}
1,history
2,Temporal variance (work of Danwu Zhang)

\subsection{Frequency Analysis of Precipitation Across Temporal Scales}

\subsection{technical routine}
...
\section{Stotistical Simulation}
