...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for j=1:N
			...
			a=svmtrain(double(Oe),double(Ie),['-s 3 -t 2 -v 2 -p 0.2 -q 0 -c ' num2str(community{j}.p(1)) ' -g '  num2str(community{j}.p(2))]);
            
            model=svmtrain(double(Oe),double(Ie),['-s 3 -t 2 -p 0.2 -q 0 -c ' num2str(community{j}.p(1)) ' -g '  num2str(community{j}.p(2))]);
    ...
    disp(x);
    disp(n_performance);
    model=svmtrain(double(Oe),double(Ie),['-s 3 -t 2 -p 0.2 -q 0 -c ' num2str(g_best(1)) ' -g '  num2str(g_best(2))]);
